...
description: Reviews WordPress must-use plugin code for architecture, security, hooks/filters, dependency behavior, performance, maintainability, and site-wide reliability. Use specifically for files under mu-plugins or functionality intentionally loaded as an MU-plugin. Works from an attached or selected project directory without requiring individual child-file attachments.
metadata:
  author: riley-childs
  version: "1.2"
---
